...
Docker image names are now named _wildfly/wildfly-builder_ and _wildfly/wildfly-runtime_.
...
Previous releases (centos7 based) and new releases (ubi8 based) are located in _wildfly-builder.json_ and _wildfly-runtime.json_ files.
...
2. Image type (lowercase) - `builder` or `runtime`
2. WildFly version or `latest`

Example: `wildfly/wildfly-builder:19.0` `wildfly/wildfly-runtime:19.0`
